        ...
        <div class="modern-content">
            ...
            <nav class="top-nav">
                <div class="top-nav-left">
                    ...
                    <p class="page-subtitle">Cập nhật thông tin khóa học</p>
                </div>
            ...
            <div class="content-area">
                ...
                <?php if (isset($_GET['msg'])): ?>
                        <div class="alert <?php echo strpos($_GET['msg'], 'thành công') !== false ? 'alert-success' : 'alert-error'; ?>">
                            <i class="fas <?php echo strpos($_GET['msg'], 'thành công') !== false ? 'fa-check-circle' : 'fa-exclamation-circle'; ?>"></i>
                ...
                <div class="form-container">
                    <div class="form-header">
                        <h3>
                            ...
                            <span style="font-size: 12px; color: var(--gray); margin-left: 8px;">(Các trường có dấu * là bắt buộc)</span>
                        </h3>
                    </div>

                    <form action="<?php echo BASE_URL; ?>/course/update/<?php echo $course['id']; ?>" method="POST" enctype="multipart/form-data" id="courseForm">
                        <div class="form-body">
                            <!-- Title -->
                            <div class="form-group">
                                ...
                                <small class="form-help">
                                    ...
                                    <span id="titleCounter" class="char-counter"><?php echo strlen($course['title']); ?>/255</span>
                                </small>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" 
                                          ...
                                          required
                                          oninput="updateCharCount('description', 'descCounter', 1000)"><?php echo htmlspecialchars($course['description']); ?></textarea>
                                <small class="form-help">
                                    Mô tả chi tiết sẽ thu hút nhiều học viên hơn
                                    <span id="descCounter" class="char-counter"><?php echo strlen($course['description']); ?>/1000</span>
                                </small>
                            ...
                            <?php if (!empty($course['image'])): ?>
                                    <div class="form-group">
                                        <div class="current-image-container">
                                            ...
                                            <small class="form-help">
                                                Nếu bạn chọn ảnh mới hoặc tích chọn xóa ảnh, ảnh hiện tại sẽ bị xóa
                                            </small>
                                        </div>
                                    </div>
                            <?php endif; ?>
                            ...
                            <div class="form-group">
                                <label class="form-label">
                                    ...
                                    Tải ảnh mới lên (tùy chọn)
                                </label>
                                
                                <div class="image-upload" id="uploadArea" onclick="document.getElementById('image').click()">
                                    <div class="upload-icon">
                                        <i class="fas fa-cloud-upload-alt"></i>
                                    </div>
                                    <div class="upload-text">Nhấp để tải ảnh mới lên</div>
                                ...
                                <small class="form-help">
                                    💡 Kích thước đề xuất: 800x450px (tỷ lệ 16:9). Nếu không chọn ảnh mới, ảnh cũ sẽ được giữ nguyên.
                                </small>
